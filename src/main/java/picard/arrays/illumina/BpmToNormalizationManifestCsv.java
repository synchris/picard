 ...
 * and is used by ZCall and GtcToVcf.
 */
...
public class BpmToNormalizationManifestCsv extends CommandLineProgram {
    static final String USAGE_DETAILS =
            "BpmToNormalizationManifestCsv takes an Illumina BPM file and generates an Illumina-formatted bpm.csv file from it. " +
    ...
    private final Log log = Log.getInstance(BpmToNormalizationManifestCsv.class);

    @Argument(shortName = StandardOptionDefinitions.INPUT_SHORT_NAME, doc = "The Input BPM")
    public File INPUT;
    ...
    protected int doWork() {
        ...
        try (BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(
            ...
            writer.newLine();
            for (IlluminaBPMLocusEntry locusEntry : bpmFile.getLocusEntries()) {
